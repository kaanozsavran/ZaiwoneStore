...
namespace zaiwoneproje
{
    public partial class Form19 : Form
    {
        ...
        public Form19(string Beden, string Renk, string Tasarim, string StokAdeti, string Fiyat, string connectionString)
        {
            InitializeComponent();
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                string UpdateQuery = "UPDATE Sweatshirt SET Beden = @yenibeden, Renk = @yenirenk,Tasarim =@yenitasarim, StokAdeti= @yenistokadeti, Fiyat = @yenifiyat where Tasarim = @yenitasarim ";
